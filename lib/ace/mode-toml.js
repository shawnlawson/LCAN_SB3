...
var TomlHighlightRules = function () {
    var keywordMapper = this.createKeywordMapper({
        "constant.language": "x|y|width|height|number|parent|radius|radiusX|radiusY|innerRadius" +
                            "|font_face|font_size|text|scale|rotation|color|stroke|opacity|keep" +
                            "|repeat|ease|delay|duration|shape|points|end|start|replace",
        "support.function": "world|speed|play|play_pause|clear|background_color",
        "string.other": "all|circle|rect|ellipse|rounded_rect|start|line|font",
        "constant.language.boolean": "true|false|cues"
    }, "identifier");
