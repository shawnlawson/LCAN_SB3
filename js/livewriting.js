...
var livewriting = (function ($) {
  ...
  // START
    ...
    execAceFunc = function (type, editor, r) {
      if (type === 'execLine' || type === 'execBlock') {
        ...
        it.lw_liveWritingJsonData[index] = {'p': 'e', 't': timestamp, 'a': type, 'd': r, 'dt' : deltaTime}
        // it.lw_liveWritingJsonData[index] = {'p': 'e', 't': timestamp, 'a': type, 'd': r, 'c': mCode, 'dt' : deltaTime}
  ...
  // END
    ...
    triggerPlayAceFunc = function (reverse, skipSchedule) {
      ...
      if (event.p === 'c') { // change in content
        ...
        // add updated marks TODO for Yjs????
        var css
      ...
      // START adding code execute
        ...
        // TODO:: let this call an exec function
